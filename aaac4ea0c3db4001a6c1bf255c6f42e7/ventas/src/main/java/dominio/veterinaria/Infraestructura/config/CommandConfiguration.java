package dominio.veterinaria.Infraestructura.config;

import dominio.veterinaria.Infraestructura.repo.MongoEventStoreRepository;
...
public class CommandConfiguration {
    ...
    private static final String PACKAGE_USE_CASE = "dominio.veterinaria.usecase";
